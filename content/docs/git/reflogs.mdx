...
- `git reflog`: List all reflog entries.
  ...
  > After identifying the desired action in the reflog, you can use the appropriate method described in [Discarding Changes](./discarding-changes.mdx)
  > together with the reflog hash to perform recovery.
