...
- `git reset <commit_hash>`: Rewind the repository to the specified commit state. 3️⃣ ->
  ...
  <Callout type="warn">This command has a rewriting or deleting effect on the repository history.</Callout>
