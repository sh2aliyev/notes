...
A queue is a data structure that stores items according to the First In First Out (FIFO) principle.
The item that has been in the queue the longest is the first one to be removed.
