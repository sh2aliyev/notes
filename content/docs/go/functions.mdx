...
<Callout>Fully independent types: Booleans, Numerics, Strings, Arrays, Structs.</Callout>
...
<Callout>Reference-containing types: Slices, Maps, Channels, Pointers, Functions, Interfaces.</Callout>
