...
func main() {
	...
	myUser := User{
		Id: 1, Name: "John", Email: "hello@example.com", Password: "12345", Age: 26, Salary: 0, Score: &score,
	}

	fmt.Printf("myUser: %+v\n", myUser) // myUser: {Id:1 Name:John Email:hello@example.com Password:12345 Age:26 Salary:0 Score:0x255956d3e048}

	jUser, _ := json.Marshal(myUser) // Converting struct to JSON

	fmt.Printf("jUser: %+v\n", string(jUser)) // jUser: {"id":1,"full_name":"John","email":"hello@example.com","age":"26","score":0}
}
```
